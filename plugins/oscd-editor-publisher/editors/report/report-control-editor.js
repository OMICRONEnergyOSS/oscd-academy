...
import { createReportControl, identity, removeControlBlock, } from '@openscd/scl-lib';
...
export class ReportControlEditor extends BaseElementEditor {
    ...
    async openClientLnAssignmentDialog(reportControl) {
...
], ReportControlEditor.prototype, "rpControlElementEditor", void 0);
__decorate([
    query('data-set-element-editor')
], ReportControlEditor.prototype, "dataSetElementEditor", void 0);
