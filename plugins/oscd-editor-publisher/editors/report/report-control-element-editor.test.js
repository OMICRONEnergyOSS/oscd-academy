...
window.customElements.define('report-control-element-editor', ReportControlElementEditor);
...
describe('ReportControl element editor component', () => {
    describe('with missing ReportControl element', () => {
        let editor;
        beforeEach(async () => {
            editor = await fixture(html `<report-control-element-editor></report-control-element-editor>`);
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await timeout(200);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#1 Missing ReportControl`);
        });
    });
    describe('with loaded ReportControl', () => {
        ...
        beforeEach(async () => {
            ...
            editor = await fixture(html `<report-control-element-editor
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#2 ReportControl without child element`);
        });
    });
    describe('with loaded ReportControl and existing OptFields, TrgOps', () => {
        ...
        it('on 1900x1200 looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#3 ReportControl with children on 1900x1200`);
        });
        it('on 800x1100 looks like the latest snapshot', async () => {
            await setViewport({ width: 599, height: 1100 });
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#4 ReportControl with children on 800x1100`);
        });
    });
    describe('indicated changes in ReportControl compared to UI', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(400);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#5 Changed ReportControl Attribute`);
        });
    });
    describe('indicated changes in OptFields compared to UI', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(400);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#6 Changed OptFields Attribute`);
        });
    });
    describe('indicated changes in TrgOps compared to UI', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(400);
            await visualDiff(editor, `reportcontrol/report-control-element-editor/#7 Changed TrgOps Attribute`);
        });
    });
});
