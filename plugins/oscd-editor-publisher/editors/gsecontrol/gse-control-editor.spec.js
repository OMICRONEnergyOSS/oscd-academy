...
describe('GSEControl editor component', () => {
    ...
    it('allows to insert new GSEControl element', async () => {
        ...
        expect(editEvent.args[0][0].detail.edit[0].node.tagName).to.equal('GSEControl');
    });
    ...
    it('allows to change an existing DataSet', async () => {
        ...
        expect(editEvent.args[0][0].detail.edit.element.tagName).to.equal('GSEControl');
        expect(editEvent.args[0][0].detail.edit.attributes.datSet).to.equal('datSet2');
    });
});
//# sourceMappingURL=gse-control-editor.spec.js.map