...
window.customElements.define('gse-control-element-editor', GseControlElementEditor);
...
describe('GSEControl element editor component', () => {
    describe('with missing GSEControl element', () => {
        let editor;
        beforeEach(async () => {
            editor = await fixture(html `<gse-control-element-editor></gse-control-element-editor>`);
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await timeout(200);
            await visualDiff(editor, `gsecontrol/gse-control-element-editor/#1 Missing DataSet`);
        });
    });
    describe('with loaded GSEControl and missing GSE', () => {
        ...
        beforeEach(async () => {
            ...
            editor = await fixture(html `<gse-control-element-editor
          .element="${gseControl}"
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `gsecontrol/gse-control-element-editor/#2 GSEControl without GSE`);
        });
    });
    describe('with loaded GSEControl and existing GSE', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `gsecontrol/gse-control-element-editor/#3 GSEControl with GSE`);
        });
        it('on Mobile looks like the latest snapshot', async () => {
            await setViewport({ width: 400, height: 1100 });
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `gsecontrol/gse-control-element-editor/#4 GSEControl with GSE on Mobile`);
        });
    });
    describe('indicated changes in GSEControl compared to UI', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(400);
            await visualDiff(editor, `gsecontrol/gse-control-element-editor/#5 Changed GSEControl Attribute`);
        });
    });
    describe('indicated changes in GSE compared to UI', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(400);
            await visualDiff(editor, `gsecontrol/gse-control-element-editor/#6 Changed GSE Attribute`);
        });
    });
});
