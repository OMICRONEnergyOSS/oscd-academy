...
import { dataSetDoc, dataSetDocWithDescs, } from './data-set-editor.testfiles.js';
...
describe('DataSet element editor component', () => {
    describe('with missing DataSet element', () => {
        let editor;
        beforeEach(async () => {
            editor = await fixture(html `<data-set-element-editor></data-set-element-editor>`);
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await timeout(300);
            await visualDiff(editor, `dataset/data-set-element-editor/#1 Missing DataSet`);
        });
    });
    describe('with DataSet reaching maxAttributes limits', () => {
        ...
        beforeEach(async () => {
            ...
            editor = await fixture(html `<data-set-element-editor
          .element="${dataSet}"
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#2 Full DataSet`);
        });
    });
    describe('with DataSet reaching 90% maxAttributes limits', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#3 Reaching 90% FCDA limit`);
        });
    });
    describe('with DataSet reaching 80% maxAttributes limits', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#4 Reaching 80% FCDA limit`);
        });
    });
    describe('with DataSet reaching 60% maxAttributes limits', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#5 Reaching 60% FCDA limit`);
        });
    });
    describe('with DataSet reaching 40% maxAttributes limits', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#6 Reaching 40% FCDA limit`);
        });
    });
    describe('with DataSet reaching 20% maxAttributes limits', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#7 Reaching 20% FCDA limit`);
        });
    });
    describe('with DataSet reaching 10% maxAttributes limits', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#8 Reaching 10% FCDA limit`);
        });
    });
    describe('with empty DataSet', () => {
        ...
        it('looks like the latest snapshot', async () => {
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#9 empty DataSet`);
        });
    });
    describe('Allows to add DataAttributes through TreeGrid', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#10 DataAttribute picker`);
        });
    });
    describe('Allows to add DataAttributes with descriptions through TreeGrid', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#10 DataAttribute picker with descriptions`);
        });
    });
    describe('Allows to add DataObjects through TreeGrid', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#11 DataObject picker`);
        });
    });
    describe('Allows to add DataObjects with descriptions through TreeGrid', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#11 DataObject picker with descriptions`);
        });
    });
    describe('Allows to re-order FCDA child elements', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(200);
            await visualDiff(editor, `dataset/data-set-element-editor/#13 Re-order FCDA`);
        });
    });
    describe('Indicated difference between UI/SCL', () => {
        ...
        it('looks like the latest snapshot', async () => {
            ...
            await editor.updateComplete;
            await timeout(500);
            await visualDiff(editor, `dataset/data-set-element-editor/#15 Enabled Save button with UI to SCL difference`);
        });
    });
});
