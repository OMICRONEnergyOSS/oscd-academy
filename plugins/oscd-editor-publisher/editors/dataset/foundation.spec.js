...
describe('Utility functions for FCDA element', () => {
    describe('addFCDAs', () => {
        ...
        const lDevice = new DOMParser()
            .parseFromString(`<LDevice inst="someLdInst"></LDevice>`, 'application/xml')
            .querySelector('LDevice');
        const anyLn = new DOMParser()
            .parseFromString(`<LN prefix="" lnClass="MMXU" inst="1"></LN>`, 'application/xml')
            .querySelector('LN');
        ...
        it('returns FCDA without lnInst for LLN0', () => {
            ...
            const newFcda = insertEdit[0].node;
